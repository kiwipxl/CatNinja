			...
			if (graphictype != 0) {
				...
				switch (graphictype) {
					...
					case 3:
						size = 2 + Math.random() * 4;
						shapebase.graphics.lineStyle();
						shapebase.graphics.beginFill(0x7028b0);
						shapebase.graphics.drawRect(0, 0, size, size);
						shapebase.cacheAsBitmap = true;
						delayrate = Math.random() * 100;
						break;
					case 4:
						size = 2 + Math.random() * 4;
						shapebase.graphics.lineStyle();
						shapebase.graphics.beginFill(0xAC580D);
						shapebase.graphics.drawRect(0, 0, size, size);
						shapebase.cacheAsBitmap = true;
						delayrate = Math.random() * 100;
						break;
					case 5:
						...
						shapebase.graphics.lineStyle();
						shapebase.graphics.beginFill(0x808080);
					...
					case 7:
						...
						shapebase.graphics.lineStyle();
						shapebase.graphics.beginFill(0x5FD331);
						shapebase.graphics.drawRect(0, 0, size, size);
						shapebase.cacheAsBitmap = true;
						delayrate = Math.random() * 100;
						break;
					case 8:
						size = 1 + Math.random() * 4;
						shapebase.graphics.lineStyle();
						shapebase.graphics.beginFill(0x60AEE8);
						shapebase.graphics.drawRect(0, 0, size, size);
						shapebase.cacheAsBitmap = true;
						delayrate = Math.random() * 100;
						break;
